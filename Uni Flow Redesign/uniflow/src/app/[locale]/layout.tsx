...
import { Cairo, IBM_Plex_Sans, JetBrains_Mono, Libre_Baskerville } from 'next/font/google';
...
export default async function LocaleLayout({
  ...
  return (
    ...
    <html
      ...
      data-theme={theme}
      className={`${arabic.variable} ${latin.variable} ${display.variable} ${mono.variable} h-full antialiased${theme === 'dark' ? ' dark' : ''}`}
    >
      <head>
