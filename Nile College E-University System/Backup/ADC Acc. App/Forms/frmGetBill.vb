...
Public Class frmGetBill
    ...
    Private Sub CombAcc1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CombPack.SelectedIndexChanged
        Try
    ...
    Private Sub btnGSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGSave.Click
        ...
        Else
            ...
            Try
                ...
                Dim SNo As Integer = GetDocSNo("سند قبض")
                ...
                Dim cmd As New SqlCommand("Insert Into Transactions (MoveNo,TransType,SNo,Source,Descr," & _
                                          ...
                                          "Values (" & MoveNo & ",N'سند قبض'," & SNo & ",N'" & Me.txtSource.Text.Trim & "',N'" & _
                ...
                Dim cmd1 As New SqlCommand("Insert Into Transactions (MoveNo,Descr," & _
                                         "Package,Acc,ChNo,Writting,TotalValueOut) " & _
