...
Public Class DailyBalancing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ADC_Acc.App.DailyBalancing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyBalancing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyBalancing = New DailyBalancing
        rpt.Site = Me.Site
        Return rpt
    End Function
