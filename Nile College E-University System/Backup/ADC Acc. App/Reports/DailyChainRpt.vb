...
Public Class DailyChainRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ADC_Acc.App.DailyChainRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyChainRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyChainRpt = New DailyChainRpt
        rpt.Site = Me.Site
        Return rpt
    End Function
