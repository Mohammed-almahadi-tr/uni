...
Public Class DailyAccTrans
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ADC_Acc.App.DailyAccTrans.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyAccTrans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyAccTrans = New DailyAccTrans
        rpt.Site = Me.Site
        Return rpt
    End Function
