...
Public Class frmUncollectedFees
    Sub FillProgram()
        Try
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            ...
            cnn.Open()
            dap.Fill(das, "UncollectedFees")
            cnn.Close()

            'One Program Case
            If Me.RTotal.Checked = True Then
                Dim rpt As New TotalUncollectedFees
            ...
            ElseIf Me.RProgram.Checked = True Then
                ...
                StrSel = "Select StudID,StudName,dbo.GetStdProgram(StudID) Acc1,Sum(TotalValueOut)-Sum(TotalValueIn) TotalValueIn  from Transactionees where Acc4=N'" & _
                ...
                cnn.Open()
                dap1.Fill(das1, "Transactionees")
                cnn.Close()

                Dim rpt As New DetailedUncollectedFees
            ...
            ElseIf RUnpaidStudentsList.Enabled = True Then
                ...
                Dim rpt As New NonPayersStudents
                rpt.SetDataSource(das)
    ...
    Private Sub frmUncollectedFees_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        FillProgram()
    End Sub
End Class