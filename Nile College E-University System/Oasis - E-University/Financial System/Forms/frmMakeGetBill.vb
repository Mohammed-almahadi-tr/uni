...
Public Class frmMakeGetBill
    ...
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim cmd As New SqlCommand("Select Distinct Acc4 From Acc1 Where Acc1=N'Current Assets' " & _
        ...
        Else
            ...
            Try
                ...
                For Each row As DataGridViewRow In Me.GridVouchers.Rows
                    'Credit side
                    cmd.CommandText = "Insert Into Transactionees (MoveNo,TransType,PaymentType,SNo,Source,Descr,Acc1,Acc2,Acc3,Acc4,Acc5,CostCenter,ChNo," & _
                                      ...
                                      "@Writting,@TotalValueIn,@UserName," & TransDate & ")"

                    'Add values
                    cmd.Parameters.Clear()
                    cmd.Parameters.AddWithValue("@MoveNo", MoveNo)
                    cmd.Parameters.AddWithValue("@TransType", "سند قبض")
                    ...
                    cmd.Parameters.AddWithValue("@TotalValueIn", CDbl(row.Cells(6).Value))
                ...
                'Debit Side
                cmd.CommandText = "Insert Into Transactionees (MoveNo,TransType,PaymentType,SNo,Source,Descr,Acc1,Acc2,Acc3,Acc4,Acc5,ChNo," & _
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        ...
        ElseIf Me.ComboDepart.SelectedIndex = -1 Then
            ...
            'ElseIf Me.ComClass.SelectedIndex = -1 Then
            '    Me.ErrProv.SetError(Me.ComClass, "Please fill in")
        ...
        Else
            Try
                ...
                Me.GridVouchers.Rows.Add(New String() {Me.txtAcc1.Text, Me.txtAcc2.Text, Me.txtAcc3.Text, Me.txtAcc4.Text, Me.txtAcc5.Text, _
                                                       Me.ComboDepart.Text, CDbl(Me.txtAmount.Text).ToString("N2"), "حذف"})
                Calculate()
    ...
    Private Sub TreeAcc_AfterSelect_1(sender As System.Object, e As System.Windows.Forms.TreeViewEventArgs) Handles TreeAcc.AfterSelect
        If e.Node.Level <> 4 Then
            Me.txtAcc1.Clear()
            Me.txtAcc2.Clear()
            Me.txtAcc3.Clear()
