...
Public Class NonPayersStudents
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OasisEUniversity.NonPayersStudents.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNonPayersStudents
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NonPayersStudents = New NonPayersStudents()
        rpt.Site = Me.Site
        Return rpt
    End Function
