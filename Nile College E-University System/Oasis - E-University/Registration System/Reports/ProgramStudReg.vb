...
Public Class ProgramStudReg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OasisEUniversity.ProgramStudReg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProgramStudReg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProgramStudReg = New ProgramStudReg()
        rpt.Site = Me.Site
        Return rpt
    End Function
