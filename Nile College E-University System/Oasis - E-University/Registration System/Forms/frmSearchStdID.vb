...
Public Class frmSearchStdID
    ...
    Sub LoadStd()
        ...
        '        Dim cmd As New SqlCommand("Select StudentIndex,StudentName,Program From StudentsProfilees " & _
        '                                 "Where StudentName like N'" & Me.txtStdName.Text & "%' " & _
        '                                 Program = " and Program=N'" & Me.CombProgram.SelectedItem & "'   Order by StudentName", cnn)
        '        'Dim cmd As New SqlCommand("Select StudentIndex,StudentName,Program From StudentsProfilees " & _
        '        '                          "Where StudentName like N'" & Me.txtStdName.Text & "%' " & _
        '        '                          Program & " and Colleges='العمارة' or Colleges='الهندسة'  Order by StudentName", cnn)
        '        'Dim cmd As New SqlCommand("Select StudentIndex,StudentName,Program From StudentsProfilees " & _
        '        '                          "Where StudentName like N'" & Me.txtStdName.Text & "%' " & _
        '        '                          Program & " and Program='علوم التمريض'  Order by StudentName", cnn)
        '        'and Program<>'علوم التمريض'
        '        Dim Reader As SqlDataReader
        '        Me.ListView1.Items.Clear()
