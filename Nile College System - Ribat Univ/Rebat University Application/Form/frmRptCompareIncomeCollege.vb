...
Public Class frmRptCompareIncomeCollege
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            ...
            Dim dap As New SqlDataAdapter("Select Distinct N'" & Me.DateTimePicker1.Value.ToString & "' Descr,N'" & _
                     ...
                     " 23:59:59') TotalValueIn,-1 * dbo.GetBalance(College,N'المنصرفات',N'" & _
                     Me.DateTimePicker1.Value.ToShortDateString & " 00:00:01',N'" & Me.DateTimePicker2.Value.ToShortDateString & _
                     " 23:59:59') TotalValueOut From Colleges Transactions Where College Is Not Null and College<>N''", cnn)
            ...
            Dim rpt As New IncomeExpensesByCollege
