...
Public Class rptDiscSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rebat_University.rptDiscSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDiscSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDiscSummary = New rptDiscSummary
        rpt.Site = Me.Site
        Return rpt
    End Function
