...
Public Class ExpensesPerc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rebat_University.ExpensesPerc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExpensesPerc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExpensesPerc = New ExpensesPerc
        rpt.Site = Me.Site
        Return rpt
    End Function
