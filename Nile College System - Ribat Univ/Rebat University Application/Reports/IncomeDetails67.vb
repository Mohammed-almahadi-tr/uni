...
Public Class IncomeDetails67
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rebat_University.IncomeDetails67.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIncomeDetails67
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IncomeDetails67 = New IncomeDetails67
        rpt.Site = Me.Site
        Return rpt
    End Function
