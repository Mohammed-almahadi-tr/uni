...
Public Class RequestBillList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rebat_University.RequestBillList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRequestBillList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RequestBillList = New RequestBillList
        rpt.Site = Me.Site
        Return rpt
    End Function
