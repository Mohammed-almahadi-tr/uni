...
Public Class CollegesRegAmount
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rebat_University.CollegesRegAmount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCollegesRegAmount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CollegesRegAmount = New CollegesRegAmount
        rpt.Site = Me.Site
        Return rpt
    End Function
