...
Public Class IncomeDetails67Total
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "IncomeDetails67Total.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rebat_University.IncomeDetails67Total.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIncomeDetails67Total
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IncomeDetails67Total = New IncomeDetails67Total
        rpt.Site = Me.Site
        Return rpt
    End Function
