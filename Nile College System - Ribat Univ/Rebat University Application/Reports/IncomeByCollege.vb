...
Public Class IncomeByCollege
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rebat_University.IncomeByCollege.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIncomeByCollege
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IncomeByCollege = New IncomeByCollege
        rpt.Site = Me.Site
        Return rpt
    End Function
