...
Public Class StudentsUnpaidList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rebat_University.StudentsUnpaidList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStudentsUnpaidList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StudentsUnpaidList = New StudentsUnpaidList
        rpt.Site = Me.Site
        Return rpt
    End Function
