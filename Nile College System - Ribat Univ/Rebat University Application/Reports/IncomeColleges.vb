...
Public Class IncomeColleges
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rebat_University.IncomeColleges.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIncomeColleges
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IncomeColleges = New IncomeColleges
        rpt.Site = Me.Site
        Return rpt
    End Function
