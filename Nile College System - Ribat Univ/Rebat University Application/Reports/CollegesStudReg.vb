...
Public Class CollegesStudReg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rebat_University.CollegesStudReg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCollegesStudReg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CollegesStudReg = New CollegesStudReg
        rpt.Site = Me.Site
        Return rpt
    End Function
